...
<body>
	<%-- 
		...
		- 파라미터를 전달해서 포함된 jsp 페이지 내에서 해당 파라미터를 추출해서 어떤 로직을 수행할 수 있다.
		- 아래의 경우 thisPage 라는 파라미터 명으로 member라는 문자열을 전달하는 것이다.
		  그러면 마치 navbar.jsp?thisPage=member 로 요청한 것과 비슷한 효과가 돼서
		  navbar.jsp 페이지 내부에서
		  
		  String thisPage = request.getParameter("thsiPage");
		  
		  코드를 수행하면 thisPage 안에는 "member" 라는 문자열이 삽입된다.
	--%>
		...
		<table class = "table table-striped">
			<thead>
				<tr class = "table-dark">
					...
					<th class="text-center">삭제2</th>
					<th class="text-center">삭제3</th>
				</tr>
			</thead>
